...
<div><h3><?php echo __('Edit Deal'); ?></h3></div>
<div class="edit-deal-box">
	...
	<div class="control-group head-group" >
		<label class="control-label"><?php echo __('Deal Status'); ?></label>
		<div class="controls">
...
// ---------------------------------------------------------- Generic Confirm  
  ...
  $(".cdelete").live("click", function(event) {
    ...
    var question = '<?php echo __('Are you sure, you want to delete this Deal!'); ?>';
