<div>
	<div>
		...
		<button type="button" id="filter-result-close" class="close" data-dismiss="alert">&times;</button>
			...
			<strong><?php echo __('User:')?> </strong><span><?php echo $search_args['search_username']; ?></span>
			<?php endif; ?>
			...
			<strong><?php echo __('Group:'); ?> </strong><span><?php echo $search_args['search_group']; ?></span>
			<?php endif; ?>
			<?php if(!empty($search_args['search_email'])): ?>
			<strong><?php echo __('Email:'); ?> </strong><span><?php echo $search_args['search_email']; ?></span>
			<?php endif; ?>
		</div>
		<?php endif; ?>
	...
	<table class="table table-bordered table-hover table-striped table-striped-success">
		<thead class="success">
		<?php
			echo $this->Html->tableHeaders(array(__('Username'),__('Group'),__('Name'),__('Email'),__('Active'),__('Action')));
		?>
		</thead>
		<tbody>
		<?php if(empty($users)): ?>
