<div>
	<div>
		...
		<div class="filter-box" style="display:none">
			<?php echo $this->Form->create('Quotation', array('url' => array_merge(array('controller'=>'quotation','action' => 'index'), $this->params['pass']),'class'=>'form-inline')); ?>
			<fieldset>
	...
	<table class="table table-bordered table-hover table-striped table-striped-warning">
		...
		<tr>
			...
			<td>
				<a href="<?php echo $this->Html->url(array('controller' => 'quotation', 'action' => 'view', $quotation['Quotation']['id'])); ?>"><i class="icon-eye-open"></i></a>
			</td>
		</tr>
		<?php endforeach;?>
		</tbody>
