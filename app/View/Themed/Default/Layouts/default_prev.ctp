  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead ">
        <div class="row">
        	<div class="span2"> 
        	<a href="<?php echo $this->Html->url('/'); ?>" ><h3 class="muted"><?php if($title) echo $title; else echo 'Zhen CRM'; ?></h3></a>
        	</div>
        	<div class="span10">
      ...
      Copyright &copy; 2013 <?php if($copyright) echo $copyright; else echo 'Zhen Company'; ?>&nbsp;| Powered By Zhen Apps |&nbsp;
      <div class="dropup">
